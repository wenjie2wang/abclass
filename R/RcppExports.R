...
rcpp_boost_group_lasso <- function(x, y, lambda, nlambda, lambda_min_ratio, group_weight, weight, intercept = TRUE, standardize = TRUE, nfolds = 0L, stratified_cv = TRUE, max_iter = 1e5L, epsilon = 1e-4, varying_active_set = TRUE, inner_min = -10.0, verbose = 0L) {
...
rcpp_logistic_group_lasso <- function(x, y, lambda, nlambda, lambda_min_ratio, group_weight, weight, intercept = TRUE, standardize = TRUE, nfolds = 0L, stratified_cv = TRUE, max_iter = 1e5L, epsilon = 1e-4, varying_active_set = TRUE, verbose = 0L) {
