...
rcpp_abclass_linear_fit <- function(x, y, control) {
    .Call('_abclass_rcpp_abclass_linear_fit', PACKAGE = 'abclass', x, y, control)
}

rcpp_abclass_linear_fit_sp <- function(x, y, control) {
    .Call('_abclass_rcpp_abclass_linear_fit_sp', PACKAGE = 'abclass', x, y, control)
}
