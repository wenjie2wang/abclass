...
#ifndef ABCLASS_ABCLASS_GROUP_SCAD_CV_H
#define ABCLASS_ABCLASS_GROUP_SCAD_CV_H
...
namespace abclass {
    ...
    template <typename T>
    inline void abclass_group_scad_cv(T& obj,
                                      ...
                                      const arma::uvec strata = arma::uvec())
    {
        ...
        for (size_t i { 0 }; i < nfolds; ++i) {
            ...
            new_obj.fit(obj.lambda_, 0, 1, obj.group_weight_,
                        obj.gamma_, obj.max_iter_, obj.epsilon_,
