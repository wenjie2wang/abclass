...
#ifndef ABCLASS_BOOST_GROUP_SCAD_H
#define ABCLASS_BOOST_GROUP_SCAD_H
...
namespace abclass
{
    ...
    template <typename T>
    class BoostGroupSCAD : public AbclassGroupSCAD<T>
    {
    private:
        // data
    ...
    public:
        ...
        BoostGroupSCAD(const T& x,
                       const arma::uvec& y,
                       const bool intercept = true,
                       const bool standardize = true,
                       const arma::vec& weight = arma::vec()) :
            AbclassGroupSCAD<T>(x, y, intercept, standardize, weight)
        {
            set_inner_min(- 5.0);
        }

        BoostGroupSCAD* set_inner_min(const double inner_min)
        {
