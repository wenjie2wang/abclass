...
namespace abclass
{
    ...
    protected:
        ...
        inline void
        apply_strong_rule(arma::umat& is_active_strong,
                          const double next_lambda, const double last_lambda,
        ...
        // kkt condition
        inline arma::umat is_kkt_failed(const arma::umat& is_active_strong,
        ...
        inline virtual void update_beta_g(arma::mat& beta, const size_t g,
                                          const size_t g1,
        ...
        inline void run_one_active_cycle(arma::mat& beta, arma::umat& is_active,
                                         const double l1_lambda,
                                         const double l2_lambda,
                                         const bool update_active,
                                         const unsigned int verbose) override;
    ...
    public:
        ...
        using AbclassCD<T_loss, T_x>::output_;
        ...
        const unsigned int verbose)
    {
        ...
        if (p_data_->intercept_) {
            const arma::rowvec delta_beta0{-mm_gradient0() / mm_lowerbound0_};
