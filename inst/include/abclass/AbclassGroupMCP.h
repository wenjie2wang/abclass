...
{
    template <typename T>
    class AbclassGroupMCP : public Abclass<T>
    {
    private:
        // data
    ...
    template <typename T>
    inline void AbclassGroupMCP<T>::run_one_active_cycle(
        arma::mat& beta,
        arma::vec& inner,
        arma::uvec& is_active,
        const double lambda,
    ...
    template <typename T>
    inline void AbclassGroupMCP<T>::run_gmd_active_cycle(
        arma::mat& beta,
        arma::vec& inner,
        arma::uvec& is_active,
        const double lambda,
    ...
    template <typename T>
    inline void AbclassGroupMCP<T>::fit(
