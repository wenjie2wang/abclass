...
{
    abclass::LogisticGroupSCAD<T> object { x, y, control };
    ...
    )
{
    ...
    control.set_intercept(intercept)->
        ...
        tune_et(nstages);
    return logistic_gscad<arma::mat>(x, y, control, main_fit);
}
    ...
    )
{
    ...
    control.set_intercept(intercept)->
        ...
        tune_cv(nfolds, stratified, alignment)->
        tune_et(nstages);
    return logistic_gscad<arma::sp_mat>(x, y, control, main_fit);
}
